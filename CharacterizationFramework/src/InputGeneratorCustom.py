...
'''
knownInstancesToVoltage[tuple([0])]=980
knownInstancesToVoltage[tuple([1])]=980
knownInstancesToVoltage[tuple([2])]=980
knownInstancesToVoltage[tuple([3])]=980
knownInstancesToVoltage[tuple([4])]=980
knownInstancesToVoltage[tuple([5])]=980
knownInstancesToVoltage[tuple([6])]=980
knownInstancesToVoltage[tuple([7])]=980
knownInstancesToVoltage[tuple([0,1])]=980
knownInstancesToVoltage[tuple([2,3])]=980
knownInstancesToVoltage[tuple([4,5])]=980
knownInstancesToVoltage[tuple([6,7])]=980
#end of not nominal
...
workSlotsToGenerate=13
maxWorkloadsPerSlot=1
randWorkloadChoiceMin=1
randWorkloadChoiceMax=2
...
jsonFileName="SeasNewTempV3.json"
#END OF VARIABLES
...
for slotID in range(workSlotsToGenerate):
    ...
    if doAllMappings:
        ...
        '''if currentCombination==0:
            chosenTopology=Topology(totalPmds,totalCores,coresPerPMD,1,3)
            activeCores=[0,1,2,4,6]'''
        if currentCombination==0:
            chosenTopology=Topology(totalPmds,totalCores,coresPerPMD,4,0)
            activeCores=[0,1,2,3,4,5,6,7]
        elif currentCombination==1:
            chosenTopology=Topology(totalPmds,totalCores,coresPerPMD,1,3)
            activeCores=[0,1,2,4,7]
        elif currentCombination==2:
            chosenTopology=Topology(totalPmds,totalCores,coresPerPMD,1,3)
            activeCores=[0,1,2,5,6]
        elif currentCombination==3:
            chosenTopology=Topology(totalPmds,totalCores,coresPerPMD,1,3)
            activeCores=[0,1,2,5,7]
        elif currentCombination==4:
            chosenTopology=Topology(totalPmds,totalCores,coresPerPMD,1,3)
            activeCores=[0,1,3,4,6]
        elif currentCombination==5:
            chosenTopology=Topology(totalPmds,totalCores,coresPerPMD,1,3)
            activeCores=[0,1,3,5,7]
        elif currentCombination==6:
            chosenTopology=Topology(totalPmds,totalCores,coresPerPMD,1,3)
            activeCores=[0,1,3,5,7]
        elif currentCombination==7:
            chosenTopology=Topology(totalPmds,totalCores,coresPerPMD,1,3)
            activeCores=[0,1,3,5,7]
        elif currentCombination==8:
            chosenTopology=Topology(totalPmds,totalCores,coresPerPMD,2,2)
            activeCores=[0,2,4,5,6,7]
        elif currentCombination==9:
            chosenTopology=Topology(totalPmds,totalCores,coresPerPMD,2,2)
            activeCores=[0,2,4,5,6,7]
        elif currentCombination==10:
            chosenTopology=Topology(totalPmds,totalCores,coresPerPMD,2,2)
            activeCores=[0,1,2,3,5,7]
        elif currentCombination==11:
            chosenTopology=Topology(totalPmds,totalCores,coresPerPMD,2,2)
            activeCores=[0,1,2,3,5,7]
        elif currentCombination==12:
            chosenTopology=Topology(totalPmds,totalCores,coresPerPMD,2,2)
            activeCores=[0,1,2,3,5,7]
